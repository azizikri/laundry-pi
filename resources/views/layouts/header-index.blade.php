<header class="f-header absolute bg-transparent js-f-header" data-theme="dark">
    ...
    <div class="f-header__nav" role="navigation">
        <div
            ...
            <ul class="f-header__list grow basis-0 lg:justify-end">
                @guest
                    <li class="f-header__item">
                        <a href="{{ route('client.login') }}" class="f-header__link"
                            aria-label="Login">
                            Login
                        </a>
                    </li>
                    ...
                    <li class="f-header__item">
                        <a href="{{ route('client.register') }}" class="f-header__link"
                            aria-label="Register">
                            Register
                        </a>
                    </li>
