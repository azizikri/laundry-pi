                    ...
                    <div class="grid grid-cols-12 gap-3 lg:gap-5">
                        @forelse ($prodcuts as $product)
                            <div class="p-table__item col-span-12 lg:col-span-4">
                                ...
                                <div class="mt-auto"><a href="#0" class="btn btn--primary btn--md w-full">Rp.
                                        {{ $product->price }}</a></div>
        ...
        <div
            ...
            <div class="grid grid-cols-12 gap-5 lg:gap-8">
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="text-sm lg:text-base text-contrast-medium mb-1.5 lg:mb-2">Produk</div>
                ...
                <div class="col-span-12 lg:col-span-8">
                    <div class="lg:pl-8">
                        <div class="text-component">
                            ...
                            <p>Kamu bisa membeli produk kita secara terpisah silahkan pencet tombol dibawah untuk
                                menavigasi ke halaman produk.</p>
                        </div>

                        <div class="flex justify-end mt-3 lg:mt-5"><a class="btn btn--subtle" href="#0">Pelajari lebih lanjut</a></div>
                    </div>
                </div>
                <div class="py-12">
                </div>
